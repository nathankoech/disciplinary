...
$sql1 = mysql_query("UPDATE student	SET regno='$regno', username='$tname', password='$password', fname='$fname', mname='$mname', lname='$lname', birth='$birth', gender='$gender', status='$status' WHERE id='$id'");
	     ...
	     <?php if(isset($hasError)) { //If errors are found ?>
            ...
            <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
              <div class="alert alert-success">
                ...
                <p>Thank you for using our Edit Student Form, <strong><?php echo $username;?></strong>! The details have been updated successfully.</p>
              </div>
            <?php } ?>
			   ...
			   <div class="panel-body">
				...
				<input name="id" type="hidden" value="<?php echo $id?>">
				  <div class="form-group">
					...
					<input name="regno" type="text" value="<?php echo $regno?>" class="form-control">
				  </div> 
				  <div class="form-group">
				  ...
				  <a href="studentslist.php" class="btn btn-large btn-success full-width">STUDENT LIST</a><br/>
				  </div>
				</form>
