...
$status = $_POST['status'];
	...
	$sql1 = mysql_query("INSERT INTO dean (username,password,fname,mname,lname,occupation,birth,gender,status) 
VALUES('$username','$password','$fname','$mname','$lname','$occupation','$birth','$gender','$status')");
		...
		<?php if(isset($hasError)) { //If errors are found ?>
            ...
            <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
              <div class="alert alert-success">
                ...
                <p>Thank you for using our Add Dean Form, <strong><?php echo $username;?></strong>! The details have been saved successfully.</p>
              </div>
            <?php } ?>
		  ...
		  <div class="row">
			...
			<div class="col-md-9">
	         ...
	         <div id="welcome" class="panel panel-success">
			   <div class="panel-heading">
				  <h3 class="panel-title">Add Dean</h3>
			   </div>
			   <div class="panel-body">
			    <form role="form" method="post" id="addstudentform">
				  ...
				  <a href="stafflist.php" class="btn btn-large btn-success full-width">DEAN LIST</a>
				  </div>
				</form>
