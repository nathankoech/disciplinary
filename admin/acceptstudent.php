					...
					while($row = mysql_fetch_array($result))
						{
							...
							echo '<td>
							<a class="btn btn-success" id="'.$row['id'].'" ><i class="icon-trash icon-large"></i>&nbsp;Accept</a>
							<a class="btn btn-danger" id="'.$row['id'].'" ><i class="icon-trash icon-large"></i>&nbsp;Decline</a></td>';
							echo '</tr>';
						}
			?>
