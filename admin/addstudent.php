	  ...
	  <?php if(isset($hasError)) { //If errors are found ?>
            ...
            <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
              <div class="alert alert-success">
                ...
                <p>Thank you for using our Add Student Form, <strong><?php echo $username;?></strong>! Now go activate the student.</p>
              </div>
            <?php } ?>
		  ...
		  <div class="row">
			 <div id="sidebar" class="col-md-3">
               ...
               echo $num_rows; ?>
						 ...
						 <hr>
						 <li><a href="inmatestransfer.php">Inmates Transfer</a></li>
						 <li><a href="addinmatestransfer.php">Add Inmates Transfer</a></li>
						 <hr>
	         ...
	         <div id="welcome" class="panel panel-success">
			   ...
			   <div class="panel-body">
			    <form role="form" method="post" id="addstudentform">
				  ...
				  <a href="studentslist.php" class="btn btn-large btn-success full-width">STUDENT LIST</a>
				  </div>
				</form>
