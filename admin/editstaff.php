...
$sql1 = mysql_query("UPDATE staff SET username='$tname', password='$password', fname='$fname', mname='$mname', lname='$lname', occupation='$occupation', birth='$birth', gender='$gender', status='$status' WHERE id='$id'");
		...
		<?php if(isset($hasError)) { //If errors are found ?>
            ...
            <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
              <div class="alert alert-success">
                ...
                <p>Thank you for using our Edit Staff Form, <strong><?php echo $username;?></strong>! The details have been updated successfully.</p>
              </div>
            <?php } ?>
		  ...
		  <div class="row">
			...
			<div class="col-md-9">
	         ...
	         <div id="welcome" class="panel panel-success">
			   <div class="panel-heading">
				  <h3 class="panel-title">Edit Staff Details</h3>
			   </div>
			   <div class="panel-body">
				...
				<input name="id" type="hidden" value="<?php echo $id?>">
				  ...
				  <div class="form-group">
					...
					<input name="occupation" type="text" value="<?php echo $occupation?>" class="form-control">
				  </div> 
				  <div class="form-group">
				  ...
				  <a href="stafflist.php" class="btn btn-large btn-success full-width">STAFF LIST</a><br/>
				  </div>
				</form>
