...
include('../connect.php');
$id = $_GET['id'];
$result = mysql_query("SELECT * FROM dean WHERE id='$id'");
...
$sql1 = mysql_query("UPDATE dean SET username='$tname', password='$password', fname='$fname', mname='$mname', lname='$lname', occupation='$occupation', birth='$birth', gender='$gender', status='$status' WHERE id='$id'");
	  ...
	  <?php if(isset($hasError)) { //If errors are found ?>
            ...
            <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
              <div class="alert alert-success">
                ...
                <p>Thank you for using our Edit Dean Form, <strong><?php echo $username;?></strong>! The details have been updated successfully.</p>
              </div>
            <?php } ?>
		  ...
		  <div class="row">
			...
			<div class="col-md-9">
	         ...
	         <div id="welcome" class="panel panel-success">
			   <div class="panel-heading">
				  <h3 class="panel-title">Edit Dean Details</h3>
			   </div>
