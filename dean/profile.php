...
$sql1 = mysql_query("UPDATE dean SET occupation='$occupation', username='$tname', password='$password', fname='$fname', mname='$mname', lname='$lname', birth='$birth', gender='$gender', status='$status' WHERE id='$id'");
    ...
    $('#editform').bootstrapValidator({
		...
		occupation: {
                ...
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z ,.-_/''""]+$/,
                        message: 'The Occupation can only consist of alphabetical and numericals'
                    }
                }
            },
		fname: {
