...
$sql1 = mysql_query("UPDATE staff SET lecid='$lecid', username='$tname', password='$password', fname='$fname', mname='$mname', lname='$lname', birth='$birth', gender='$gender', status='$status' WHERE id='$id'");
