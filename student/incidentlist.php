					...
					while($row = mysql_fetch_array($result))
						{
							...
							echo '<td>'.$row['incidentcategory'].'</td>';
							echo '<td>'.$row['context'].'</td>';
							echo '<td>'.$row['campuslocation'].'</td>';
							echo '<td>'.$row['outsidelocation'].'</td>';
							echo '<td>'.$row['incidenttime'].'</td>';
							echo '<td>'.$row['date'].'&nbsp;'.$row['month'].'&nbsp;'.$row['year'].'</td>';
							echo '<td>'.$row['message'].'</td>';
							echo '<td>'.strftime("%b %d, %Y", strtotime($row["date_added"])).'</td>';
							echo '<td>
							<a class="btn btn-success" href="viewlist.php?id=' . $row['id'] . '"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>
