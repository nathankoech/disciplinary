...
$sql1 = mysql_query("UPDATE student SET username='$tname', password='$password', regno='$regno', fname='$fname', mname='$mname', lname='$lname', birth='$birth', gender='$gender', status='$status' WHERE id='$id'");
...
<html lang="en-US" class="no-js">
	<head>
		...
		=============================================== -->
		<meta charset="utf-8">
		<title>Student - Displinary Management System</title>
	  ...
	  <?php if(isset($hasError)) { //If errors are found ?>
            ...
            <?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
              <div class="alert alert-success">
                <p><strong>Profile Successfully Updated!</strong></p>
                <p>Thank you for using our Update Profile form, <strong><?php echo $username;?></strong>! Your Profile was updated successfully.</p>
              </div>
            <?php } ?>
				...
				<div class="panel panel-success">
					...
					<div id="sidenav" class="panel-body">
					   <ul class="list-unstyled nav sidenav">
						 ...
						 <?php
						   include('../connect.php');
						   $result = mysql_query("SELECT * FROM message WHERE regno='$regno'");
						   $num_rows = mysql_num_rows($result);
						   echo $num_rows; ?>
						   </span>
						</a></li>
			   ...
			   <div class="panel-body">
				...
				<input name="id" type="hidden" value="<?php echo $id?>">
				  <div class="form-group">
					...
					<input name="regno" type="text" value="<?php echo $regno?>" class="form-control" readonly="readonly">
				  </div>
				  <div class="form-group">
